...
pnt(pnt[(4*i*x^3+(-4*i)*x^2*sqrt(x^2+y^2)+4*i*x^2*sqrt(x^2+y^2-2*x+1)+(-6*i)*x^2+4*i*x*y^2+4*x*y*sqrt(x^2+y^2)-4*x*y*sqrt(x^2+y^2-2*x+1)+4*x*y+(-4*i)*x*sqrt(x^2+y^2)*sqrt(x^2+y^2-2*x+1)+6*i*x*sqrt(x^2+y^2)+(-2*i)*x*sqrt(x^2+y^2-2*x+1)+2*i*x+(-2*i)*y^2-2*y*sqrt(x^2+y^2)+2*y*sqrt(x^2+y^2-2*x+1)-2*y+2*i*sqrt(x^2+y^2)*sqrt(x^2+y^2-2*x+1)+(-2*i)*sqrt(x^2+y^2))/(8*x*y-4*y),56,M]),
pnt(pnt[(4*i*x^3+(-4*i)*x^2*sqrt(x^2+y^2)+4*i*x^2*sqrt(x^2+y^2-2*x+1)+(-6*i)*x^2+4*i*x*y^2+4*x*y*sqrt(x^2+y^2)-4*x*y*sqrt(x^2+y^2-2*x+1)+4*x*y+(-4*i)*x*sqrt(x^2+y^2)*sqrt(x^2+y^2-2*x+1)+6*i*x*sqrt(x^2+y^2)+(-2*i)*x*sqrt(x^2+y^2-2*x+1)+2*i*x+(-2*i)*y^2-2*y*sqrt(x^2+y^2)+2*y*sqrt(x^2+y^2-2*x+1)-2*y+2*i*sqrt(x^2+y^2)*sqrt(x^2+y^2-2*x+1)+(-2*i)*sqrt(x^2+y^2))/(8*x*y-4*y),56,N]),
0,
...
"Done",
"Done",
pnt(pnt[(4*i*xa^3+(-4*i)*xa^2*sqrt(xa^2+ya^2+2*xa+1)+4*i*xa^2*sqrt(xa^2+ya^2-2*xa+1)+4*i*xa*ya^2+4*xa*ya*sqrt(xa^2+ya^2+2*xa+1)-4*xa*ya*sqrt(xa^2+ya^2-2*xa+1)+(-4*i)*xa*sqrt(xa^2+ya^2+2*xa+1)*sqrt(xa^2+ya^2-2*xa+1)+4*i*xa*sqrt(xa^2+ya^2+2*xa+1)+4*i*xa*sqrt(xa^2+ya^2-2*xa+1)+(-4*i)*xa)/(8*xa*ya),56,P]),
(2*xa*ya/4/ya-(4*xa*ya*sqrt(xa^2+ya^2+2*xa+1)-4*xa*ya*sqrt(xa^2+ya^2-2*xa+1))/8/xa/ya)^2+((-xa^2+ya^2+1)/4/ya-(4*xa^3-4*xa^2*sqrt(xa^2+ya^2+2*xa+1)+4*xa^2*sqrt(xa^2+ya^2-2*xa+1)+4*xa*ya^2-4*xa*sqrt(xa^2+ya^2+2*xa+1)*sqrt(xa^2+ya^2-2*xa+1)+4*xa*sqrt(xa^2+ya^2+2*xa+1)+4*xa*sqrt(xa^2+ya^2-2*xa+1)-4*xa)/8/xa/ya)^2,
(4*xa^2-4*xa*sqrt(xa^2+ya^2+2*xa+1)+4*xa*sqrt(xa^2+ya^2-2*xa+1)+4*ya^2-4*sqrt(xa^2+ya^2+2*xa+1)*sqrt(xa^2+ya^2-2*xa+1)+4*sqrt(xa^2+ya^2+2*xa+1)+4*sqrt(xa^2+ya^2-2*xa+1)-4)*1/8/ya,
(4*xa^4-4*xa^3*sqrt(xa^2+ya^2+2*xa+1)+4*xa^3*sqrt(xa^2+ya^2-2*xa+1)+6*xa^2*ya^2-4*xa^2*sqrt(xa^2+ya^2+2*xa+1)*sqrt(xa^2+ya^2-2*xa+1)+4*xa^2*sqrt(xa^2+ya^2+2*xa+1)+4*xa^2*sqrt(xa^2+ya^2-2*xa+1)-8*xa^2-4*xa*ya^2*sqrt(xa^2+ya^2+2*xa+1)+4*xa*ya^2*sqrt(xa^2+ya^2-2*xa+1)+4*xa*sqrt(xa^2+ya^2+2*xa+1)-4*xa*sqrt(xa^2+ya^2-2*xa+1)+2*ya^4-2*ya^2*sqrt(xa^2+ya^2+2*xa+1)*sqrt(xa^2+ya^2-2*xa+1)+2*ya^2+4*sqrt(xa^2+ya^2+2*xa+1)*sqrt(xa^2+ya^2-2*xa+1)-4*sqrt(xa^2+ya^2+2*xa+1)-4*sqrt(xa^2+ya^2-2*xa+1)+4)/(4*ya^2),
"Done",
0,
"Done",
0,
